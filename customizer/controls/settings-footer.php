...
//----------------------Footer Columns 1----------------------------------
	$wp_customize->add_setting('complete[foot_cols1_title]', array(
		'type' => 'option',
		'default'	=> __('ABOUT PERFECT','complete'),
...
$wp_customize->add_setting('complete[foot_cols1_content]', array(
	'type' => 'option',
	'default' => '<p>Aliquam porta tincidunt enim. Sed temporing nulla sedding facilis egestas, lorem lacus and elementum mi, malesuada ornare ipsum erat convallis ipsum orem lacus elementum porta tincidunt enim.</p><p>Aenean ac convallis nibh. In non arcu vel lacus fringilla tempus. Nullam dictum placerat nisi...</p>',
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
$wp_customize->add_setting('complete[foot_cols3_content]', array(
	'type' => 'option',
	'default' => '<p>Etiam aliquet dictum risus, a pharetra tortor blandit eget. Praesent nec dictum dolor, eget faucibus neque.</p><div class="spacecode" style="height:20px;"></div> Phone:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; +1 500 000 0000<br>E-mail:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;demo@lorem.com<br>Website:&nbsp;&nbsp;&nbsp;&nbsp;http://demo.com',
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
$wp_customize->add_setting('complete[foot_cols4_content]', array(
	'type' => 'option',
	'default' => '<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>[social_area]
